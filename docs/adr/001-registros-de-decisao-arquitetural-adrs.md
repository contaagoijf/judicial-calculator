...
- Nome de arquivo: `NNN-descricao-curta-em-kebab-case.md`, com `NNN` sequencial de 3 dígitos (`000`, `001`, `002`, ...).
...
- Documentos novos de investigação/correção que cheguem a uma decisão devem, a partir de agora, nascer diretamente em `docs/adr/` no formato do template conforme a estrutura Context/Decision/Consequences, em vez de como um arquivo solto em `docs/`.
